...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // This debounce function merely stops functioned firing too
  // often on repetitive events (such as resize/scroll).
  ...
  // Remove the class from the body inside a debounce.
