(function() {
  ...
  var radial = {
    ...
    animateSVG: function(amount, inputValue) {
      ...
      /* While simultaneously tweening the percentage value in Text from the counter
         value to the value of the input (that the user sets with the slider) */
      var counter = { var: 0 };
